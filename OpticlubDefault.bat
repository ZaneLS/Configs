...
echo Re-Enabling TCP selective acks (Default Value = 0/deleted on fresh install)
Reg delete "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameter" /v "SackOpts" /f
