...
color b
chcp 65001 >nul
title OptiClub V6.6-BETA "SAFE-AGGRESSIVE" Performances CFG -https://discord.gg/Np77z4C9qs
...
timeout /t 3 /nobreak > NUL
powershell Invoke-WebRequest "https://github.com/ZaneLS/Configs/raw/refs/heads/main/OptiClub-Safe-Aggressive.cfg" -OutFile "%temp%\OptiClub-Safe-Aggressive.cfg"
set OOSUPath="%temp%\OOSU10.exe"
set ConfigPath="%temp%\OptiClub-Safe-Aggressive.cfg"
